...
if (isset($_POST['task'])) {
    ...
    if ($res) {
        ...
        echo "<script> window.location = './important.php' </script>";
    } else {
...
if (isset($_POST['id_todo_important'])) {
    ...
    $sql = "update todo set label='reguler' where id_todo = $id_todo ";
    $res = mysqli_query($conn, $sql);
    if ($res) {
        echo "<script> alert('Berhasil Ubah')  </script>";
        echo "<script> window.location = './important.php' </script>";
    ...
    <div class="wrapper">
        ...
        <div class="right">
            ...
            <div class="content">
                ...
                <!-- keterangan waktu -->
                    <div class="date">
                        <h1>Important <i class="fas fa-star    "></i></h1>
                        <?= date('d F Y', strtotime(date('Y-m-d'))) ?>
                    </div>
                <!-- keterangan waktu -->

                    <!-- tombol fungsi important, edit delete -->
                    <div class="tasks">
                        <?php
                        $sqlTodo = "select * from todo where id_user=$id_user and label='important'";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Tasks - <span
                                        class="badge badge-warning text-light">Important</span></p>
                                <a href="#" class="btn btn-secondary btn-important" data-id="<?= $row['id_todo'] ?>"><i
