        ...
        <div class="right">
            ...
            <div class="content">
                <div class="content-wrapper">
                    ...
                    <div class="tasks">
                        <?php
                        $sqlTodo = "select * from todo where id_user=$id_user and label='reguler'";
                    ...
                    <!-- label task -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="#" class="btn btn-warning btn-important" data-id="<?= $row['id_todo'] ?>"><i class="fas fa-star    text-light"></i></a>
                                    <a data-toggle="modal" data-target="#editModal<?= $row['id_todo']  ?>" class="btn btn-primary"><i class="fas fa-edit    text-light"></i></a>
                                    <a onclick="return confirm('Delete?') " href="./action/task_delete.php?id_todo=<?= $row['id_todo'] ?>" class="btn btn-danger"><i class="fas fa-trash    text-light"></i></a>
                                </div>
                            </div>
